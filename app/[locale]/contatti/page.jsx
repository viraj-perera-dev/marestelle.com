  ...
  return (
    ...
    <main className="bg-white text-gray-800">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/assets/sectionImages/hero_ragazza.webp')" }}
      >
        ...
        <div className="grid md:grid-cols-2 grid-cols-1">
          ...
          <div className="w-full md:w-2/3 mx-auto flex flex-col justify-center py-20 md:py-0 px-5">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link href={t('downloadButtonLink')} target="_blank" rel="noopener noreferrer">
                <button className="flex items-center justify-center gap-2 font-semibold text-md md:text-xl border border-blue-500 text-blue-500 w-full py-3 rounded-full hover:bg-blue-600 hover:text-white transition duration-300 cursor-pointer">
            ...
            <div style={{marginTop: "14px", textAlign: "center"}}>
              <a href="https://www.google.com/maps?q=42.120393, 15.497450" target="_blank">
                <img src={`https://maps.googleapis.com/maps/api/staticmap?center=42.120393, 15.497450&zoom=15&size=600x300&markers=color:red%7C42.120393, 15.497450&key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}`} alt="Mappa punto di ritrovo" className="w-full max-w-full rounded-2xl border border-blue-600" />
              </a>
            </div>
          </div>
